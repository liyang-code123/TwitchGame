...
public class MySQLTableCreator {
    ...
    public static void main(String[] args) {
        try {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver").getDeclaredConstructor().newInstance(); //反射机制
            ...
            // Step 4: insert fake user 1111/3229c1097c00d497a0fd282d586be050. id, password, first name, last name. MD5 Hash
